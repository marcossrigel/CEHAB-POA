...
if ($token === '' || empty($_SESSION['form_token']) || !hash_equals($_SESSION['form_token'], $token)) {
  http_response_code(400);
  echo "Requisição inválida ou repetida. Volte e tente novamente.";
  exit;
}
unset($_SESSION['form_token']); // consome
